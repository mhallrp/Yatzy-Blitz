🎲 A classic Yatzy style game with local or online multiplayer functionality via the apple GameCenter API but also single player with a virtual auto play opponent.
